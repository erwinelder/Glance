...
private val LightDefaultPalette = GlanceColors(
    ...
    success = md_theme_light_default_success,
    successGradient = md_theme_light_default_successGradient,
    errorGradient = md_theme_light_default_errorGradient,
...
private val DarkDefaultPalette = GlanceColors(
    ...
    success = md_theme_dark_default_success,
    successGradient = md_theme_dark_default_successGradient,
    errorGradient = md_theme_dark_default_errorGradient,
...
private val DarkBluePalette = GlanceColors(
    ...
    success = md_theme_dark_blue_success,
    successGradient = md_theme_dark_blue_successGradient,
    errorGradient = md_theme_dark_blue_errorGradient,

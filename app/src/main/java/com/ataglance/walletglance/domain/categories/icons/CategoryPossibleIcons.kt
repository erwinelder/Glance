package com.ataglance.walletglance.domain.categories.icons
...
data class CategoryPossibleIcons(
    ...
    val cinemaTheater: CategoryIcon = CategoryIcon.CinemaTheater,
    ...
    fun getIconByName(name: String): CategoryIcon {
        return when (name) {
            ...
            CategoryIcon.CinemaTheater.name -> cinemaTheater

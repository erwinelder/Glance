...
data class DefaultCategoriesPackage(
    ...
    fun get(): GroupedCategoriesByType {
            ...
            expense = listOf(
                GroupedCategories(
                    category = Category(
                        ...
                        name = resourceManager.getString(R.string.food_and_drinks),
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.groceries),
                        ...
                        Category(
                            ...
                            name = resourceManager.getString(R.string.restaurant),
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        name = resourceManager.getString(R.string.housing),
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.utilities),
                            icon = CategoryIcon.Housing,
                            color = CategoryColor.Camel
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.services),
                            icon = CategoryIcon.Housing,
                            color = CategoryColor.Camel
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.rent),
                            icon = CategoryIcon.Housing,
                            color = CategoryColor.Camel
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.mortgage),
                            icon = CategoryIcon.Housing,
                            color = CategoryColor.Camel
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.maintenance),
                            icon = CategoryIcon.Housing,
                            color = CategoryColor.Camel
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.purchase),
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        name = resourceManager.getString(R.string.shopping),
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.clothes_and_shoes),
                        ...
                        Category(
                            ...
                            name = resourceManager.getString(R.string.electronics_accessories),
                            icon = CategoryIcon.Shopping,
                            color = CategoryColor.Pink
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.cleaning_and_laundry),
                            icon = CategoryIcon.Shopping,
                            color = CategoryColor.Pink
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.health_and_beauty),
                            icon = CategoryIcon.Shopping,
                            color = CategoryColor.Pink
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.home_and_garden),
                            icon = CategoryIcon.Shopping,
                            color = CategoryColor.Pink
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.books),
                            icon = CategoryIcon.Shopping,
                            color = CategoryColor.Pink
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.joy_and_gifts),
                            icon = CategoryIcon.Shopping,
                            color = CategoryColor.Pink
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.kids), icon = CategoryIcon.Shopping,
                            color = CategoryColor.Pink
                        ),
                        Category(
                            id = 29, type = CategoryType.Expense,
                            orderNum = 9, parentCategoryId = 3,
                            name = resourceManager.getString(R.string.pets_and_animals),
                            icon = CategoryIcon.Shopping,
                            color = CategoryColor.Pink
                        )
                    )
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        name = resourceManager.getString(R.string.transport),
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.public_transport),
                            icon = CategoryIcon.Transport,
                            color = CategoryColor.Green
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.taxi),
                            icon = CategoryIcon.Transport,
                            color = CategoryColor.Green
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.business_trips),
                            icon = CategoryIcon.Transport,
                            color = CategoryColor.Green
                        )
                    )
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        name = resourceManager.getString(R.string.vehicle),
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.parking),
                            icon = CategoryIcon.Vehicle,
                            color = CategoryColor.Red
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.fuel),
                            icon = CategoryIcon.Vehicle,
                            color = CategoryColor.Red
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.leasing),
                            icon = CategoryIcon.Vehicle,
                            color = CategoryColor.Red
                        ),
                        Category(
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        name = resourceManager.getString(R.string.digital_life),
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.internet_communication),
                            icon = CategoryIcon.DigitalLife,
                            color = CategoryColor.LightBlue
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.professional_subs),
                        ...
                        Category(
                            ...
                            name = resourceManager.getString(R.string.entertainment_subs),
                        ...
                        Category(
                            ...
                            name = resourceManager.getString(R.string.games),
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        name = resourceManager.getString(R.string.medicine),
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.drugs_and_vitamins),
                            icon = CategoryIcon.Medicine,
                            color = CategoryColor.Lavender
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.insurance),
                            icon = CategoryIcon.Medicine,
                            color = CategoryColor.Lavender
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.doctor),
                            icon = CategoryIcon.Medicine,
                            color = CategoryColor.Lavender
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.teeth_care),
                            icon = CategoryIcon.Medicine,
                            color = CategoryColor.Lavender
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.vaccination),
                            icon = CategoryIcon.Medicine,
                            color = CategoryColor.Lavender
                        )
                    )
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        name = resourceManager.getString(R.string.education),
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.school_and_university),
                            icon = CategoryIcon.Education,
                            color = CategoryColor.Blue
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.courses),
                            icon = CategoryIcon.Education,
                            color = CategoryColor.Blue
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.studding_materials),
                            icon = CategoryIcon.Education,
                            color = CategoryColor.Blue
                        )
                    )
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        name = resourceManager.getString(R.string.travels),
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.tickets),
                        ...
                        Category(
                            ...
                            name = resourceManager.getString(R.string.accommodation),
                        ...
                        Category(
                            ...
                            name = resourceManager.getString(R.string.entertainment),
                        ...
                        Category(
                            ...
                            name = resourceManager.getString(R.string.other_category),
                            icon = CategoryIcon.Travels,
                            color = CategoryColor.Aquamarine
                        )
                    )
                ...
                GroupedCategories(
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.hobbies),
                            icon = CategoryIcon.Entertainment,
                            color = CategoryColor.Orange
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.cinema_theater_concerts),
                        ...
                        Category(
                            ...
                            name = resourceManager.getString(R.string.sport),
                            icon = CategoryIcon.Entertainment,
                            color = CategoryColor.Orange
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.events_hanging_out),
                            icon = CategoryIcon.Entertainment,
                            color = CategoryColor.Orange
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.alcohol_and_smoking),
                            icon = CategoryIcon.Entertainment,
                            color = CategoryColor.Orange
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.gifts_and_charity),
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        name = resourceManager.getString(R.string.investments),
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.shares),
                            icon = CategoryIcon.Investments,
                            color = CategoryColor.Yellow
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.cryptocurrencies),
                            icon = CategoryIcon.Investments,
                            color = CategoryColor.Yellow
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.realty),
                            icon = CategoryIcon.Investments,
                            color = CategoryColor.Yellow
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.savings),
                            icon = CategoryIcon.Investments,
                            color = CategoryColor.Yellow
                        )
                    )
                ...
                GroupedCategories(
                    ...
                    subcategoryList = listOf(
                        Category(
                            ...
                            name = resourceManager.getString(R.string.transfers),
                        ...
                        Category(
                            ...
                            name = resourceManager.getString(R.string.missing),
                        ...
                        Category(
                            ...
                            name = resourceManager.getString(R.string.post_services),
                            icon = CategoryIcon.Missing,
                            color = CategoryColor.GrayDefault
                        ),
                        Category(
                            ...
                            name = resourceManager.getString(R.string.public_toilets),
                            icon = CategoryIcon.Other,
                            color = CategoryColor.GrayDefault
                        ),
                        Category(
            ...
            income = listOf(
                GroupedCategories(
                    category = Category(
                        ...
                        orderNum = 1, parentCategoryId = null,
                        name = resourceManager.getString(R.string.salary),
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        orderNum = 2, parentCategoryId = null,
                        name = resourceManager.getString(R.string.scholarship),
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        orderNum = 3, parentCategoryId = null,
                        name = resourceManager.getString(R.string.sale),
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        orderNum = 5, parentCategoryId = null,
                        name = resourceManager.getString(R.string.refunds),
                ...
                GroupedCategories(
                    category = Category(
                        ...
                        orderNum = 7, parentCategoryId = null,
                        name = resourceManager.getString(R.string.gifts),
                        icon = CategoryIcon.Gifts,
                        color = CategoryColor.Lavender
                    ),
                    subcategoryList = emptyList()

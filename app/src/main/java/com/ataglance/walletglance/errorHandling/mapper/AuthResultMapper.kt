...
fun Result<AuthSuccess, AuthError>.toResultState(): ResultTitleWithMessageState {
    return when (this) {
...
fun AuthSuccess.toResultState(): ResultTitleWithMessageState {
    return ResultTitleWithMessageState(
        isSuccessful = true,
...
fun AuthError.toResultState(): ResultTitleWithMessageState {
    return ResultTitleWithMessageState(
        isSuccessful = false,
        titleRes = this.asTitleRes(),
        messageRes = this.asMessageRes()
...
@StringRes private fun AuthSuccess.asTitleRes(): Int {
    return when (this) {
        AuthSuccess.TokenIsValid -> R.string.welcome_back_to_glance
...
@StringRes private fun AuthSuccess.asButtonTextRes(): Int {
    return when (this) {
        AuthSuccess.TokenIsValid -> R.string._continue
